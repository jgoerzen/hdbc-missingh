...
testsrc/runtests: all $(wildcard testsrc/*.hs) $(wildcard testsrc/*/*.hs) $(wildcard testsrc/*/*/*.hs)
	cd testsrc && ghc --make -package mtl -package HUnit -package MissingH -package HDBC-sqlite3 -package HDBC-postgresql $(GHCPARMS) -o runtests  -i../dist/build:.. runtests.hs
